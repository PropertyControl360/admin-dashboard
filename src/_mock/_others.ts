...
export const _notifications = [...Array(9)].map((_, index) => ({
  ...
  title:
    (index === 0 && "The waves crashed against the shore, causing it to echo with the timeless rhythm of the sea.") ||
    (index === 1 &&
      "You received monthly rent payment for 18605 Thomoson Circle Apt.") ||
    (index === 2 &&
      "You received monthly rent payment for 18605 Thomoson Circle Apt.") ||
    (index === 3 &&
      "You received monthly rent payment for 18605 Thomoson Circle Apt.") ||
